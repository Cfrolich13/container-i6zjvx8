...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i6zjvx8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i6zjvx8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Cfrolich13/container-i6zjvx8.git
cd container-i6zjvx8
```
...
```
docker attach container-i6zjvx8
```
